...
type PatrolRecord struct {
	...
	// 服务器详情
	HealthyServers  string `json:"healthyServers" gorm:"type:text"`   // JSON数组
	WarningServers  string `json:"warningServers" gorm:"type:text"`   // JSON数组
	CriticalServers string `json:"criticalServers" gorm:"type:text"`  // JSON数组
	OfflineServerList string `json:"offlineServerList" gorm:"type:text"` // JSON数组
...
type DailyReport struct {
	...
	// 服务器详情
	TopCPUServers   []ServerUsage  `json:"topCpuServers"`
	TopMemoryServers []ServerUsage `json:"topMemoryServers"`
	TopDiskServers  []ServerUsage  `json:"topDiskServers"`
